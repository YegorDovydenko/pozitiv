<?php
namespace EdgeCore\PostTypes\Slider;

use EdgeCore\Lib;

/**
 * Class SliderRegister
 * @package EdgeCore\PostTypes\Slider
 */
class SliderRegister implements Lib\PostTypeInterface {
    ...
    private function registerPostType() {
        ...
        if(edgt_core_theme_installed()) {
            $menuPosition = $ratio_edge_Framework->getSkin()->getMenuItemPosition('slider');
            $menuIcon = $ratio_edge_Framework->getSkin()->getMenuIcon('slider');
        }
