...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $ratio_edge_Framework, $ratio_edge_options;
        ...
        if(edgt_core_theme_installed()) {
            $menuPosition = $ratio_edge_Framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $ratio_edge_Framework->getSkin()->getMenuIcon('portfolio');

            if(isset($ratio_edge_options['portfolio_single_slug'])) {
                if($ratio_edge_options['portfolio_single_slug'] != ""){
                    $slug = $ratio_edge_options['portfolio_single_slug'];
                }
            }
        }
