			...
			<div class="edgtf-testimonial-text-inner">
				...
				<?php if ($show_author == "yes") { ?>
					<div class = "edgtf-testimonial-author">
						<h6 class="edgtf-testimonial-author-text" <?php ratio_edge_inline_style($author_style);?>>
							- <?php echo esc_attr($author)?><?php if($show_position == "yes" && $job !== ''){ ?><span class="edgtf-testimonials-job" <?php ratio_edge_inline_style($position_style);?>>, <?php echo esc_attr($job)?></span><?php }?>
						</h6>
					</div>
				<?php } ?>
