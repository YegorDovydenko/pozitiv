...
$header_meta_box = ratio_edge_add_meta_box(
    array(
...
ratio_edge_add_meta_box_field(
	array(
		...
		'options' => array(
			...
			'header-slide-down'		=> 'Slide Down Header Layout'
		),
		'args' => array(
			"dependence" => true,
			"hide" => array(
...
ratio_edge_add_meta_box_field(
	array(
		...
		'description' => 'Choose a transparency for the header border bottom color (0 = fully transparent, 1 = opaque)',
		'parent' => $header_standard_type_meta_container,
		'args' => array(
			'col_width' => 2
		)
