...
class RatioEdgeSocialIconWidget extends RatioEdgeWidget {
    ...
    public function widget($args, $instance) {
        ...
        <a class="edgtf-social-icon-widget-holder" <?php echo ratio_edge_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php ratio_edge_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
