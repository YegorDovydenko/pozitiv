...
if (!function_exists('ratio_edge_get_footer')) {
	...
	function ratio_edge_get_footer() {
		...
		$parameters['display_footer_top'] = (ratio_edge_options()->getOptionValue('show_footer_top') == 'yes') ? true : false;
		$parameters['display_footer_bottom'] = (ratio_edge_options()->getOptionValue('show_footer_bottom') == 'yes') ? true : false;
