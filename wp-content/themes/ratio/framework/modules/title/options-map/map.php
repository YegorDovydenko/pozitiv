	...
	function ratio_edge_title_options_map() {
		...
		ratio_edge_add_admin_field(
			array(
				...
				'type' => 'text',
				'default_value' => '',
				'label' => 'Title on Default Front Page',
				'description' => 'Define a title for your front page if your front page settings (in Settings > Reading) are set to display your latest posts instead of a static page.',
		...
		ratio_edge_add_admin_field(
			array(
				...
				'description' => 'Set titl content to be in grid',
				'parent' => $show_title_area_container,
			)
		);
		...
		ratio_edge_add_admin_field(
			array(
				...
				'description' => 'This option will display Separator in Title Area',
				'parent' => $title_area_type_container,
				'args' => array(
					'dependence' => true,
					'dependence_hide_on_yes' => '',
