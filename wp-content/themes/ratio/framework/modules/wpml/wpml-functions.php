...
if(!function_exists('ratio_edge_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function ratio_edge_get_wpml_pages_for_current_page() {
...
if(!function_exists('ratio_edge_disable_wpml_css')) {
    function ratio_edge_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'ratio_edge_disable_wpml_css');
}