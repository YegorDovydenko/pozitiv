<?php
namespace RatioEdge\Modules\Shortcodes\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Edge Elements Holder', 'ratio'),
			'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . ratio_edge_get_class_attribute($elements_holder_class) . ' ' . ratio_edge_get_inline_attr($elements_holder_style, 'style'). '>';
