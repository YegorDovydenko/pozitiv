<?php
namespace RatioEdge\Modules\Shortcodes\Counter;
...
class Countdown implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Edge Countdown', 'ratio'),
			'base' => $this->getBase(),
			'category' => 'by EDGE',
			'admin_enqueue_css' => array(ratio_edge_get_skin_uri().'/assets/css/edgtf-vc-extend.css'),
	...
	public function render($atts, $content = null)
	{
		...
		$html = ratio_edge_get_shortcode_module_template_part('templates/countdown-template', 'countdown', '', $params);
