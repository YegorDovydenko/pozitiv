<?php
namespace RatioEdge\Modules\Shortcodes\IconWithText;

use RatioEdge\Modules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package RatioEdge\Modules\Shortcodes\IconWithText
 */
class IconWithText implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Edge Icon With Text', 'ratio'),
            'base'                      => $this->base,
            ...
            'params'                    => array_merge(
                ...
                array(
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Icon Background Second (Gradient) Color',
                        'param_name'  => 'icon_background_sec_color',
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Icon Hover Background Second (Gradient) Color',
                        'param_name'  => 'icon_hover_background_sec_color',
                        'description' => 'Enter this color if you want to create gradient background',
                        'dependency'  => array('element' => 'icon_type', 'value' => array('square', 'circle')),
                        'group'       => 'Icon Settings'
                    ),
                    ...
                    array(
                        ...
                        'description'=> 'If not entered link will be set on icon',
    ...
    public function render($atts, $content = null) {
        $default_atts = array(
            ...
            'icon_background_sec_color'   => '',
            'icon_hover_background_color' => '',
            'icon_hover_background_sec_color' => '',
            'icon_border_color'           => '',
        ...
        return ratio_edge_get_shortcode_module_template_part('templates/iwt', 'icon-with-text', $params['icon_position'], $params);
    }
    ...
    private function getIconParameters($params) {
        ...
        if(empty($params['custom_icon'])) {
            ...
            if(!empty($params['icon_background_sec_color'])) {
                $params_array['background_sec_color'] = $params['icon_background_sec_color'];
            }
            ...
            if(!empty($params['icon_hover_background_sec_color'])) {
                $params_array['hover_background_sec_color'] = $params['icon_hover_background_sec_color'];
            }
    ...
    private function getContentStyles($params) {
        ...
        if($params['icon_position'] == 'left' && !empty($params['text_left_padding'])) {
            $styles[] = 'padding-left: '.ratio_edge_filter_px($params['text_left_padding']).'px';
        }

        if($params['icon_position'] == 'right' && !empty($params['text_right_padding'])) {
            $styles[] = 'padding-right: '.ratio_edge_filter_px($params['text_right_padding']).'px';
        }
