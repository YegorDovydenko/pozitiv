...
if(!function_exists('ratio_edge_tabs_map')) {
    function ratio_edge_tabs_map() {
		...
		$tabs_color_group = ratio_edge_add_admin_group(array(
            'name' => 'tabs_color_group',
            'title' => 'Tab Navigation Color Styles',
			'description' => 'Set color styles for tab navigation',
            'parent' => $panel
        ));
		$tabs_color_row = ratio_edge_add_admin_row(array(
            'name' => 'tabs_color_row',
            'next' => true,
		...
		$active_tabs_color_group = ratio_edge_add_admin_group(array(
		...
		$active_tabs_color_row = ratio_edge_add_admin_row(array(
		...
		ratio_edge_add_admin_field(array(
            'parent'        => $active_tabs_color_row,
            'type'          => 'colorsimple',
            'name'          => 'tabs_back_sec_color_active',
            'default_value' => '',
    ...
    add_action('ratio_edge_options_elements_map', 'ratio_edge_tabs_map');
}