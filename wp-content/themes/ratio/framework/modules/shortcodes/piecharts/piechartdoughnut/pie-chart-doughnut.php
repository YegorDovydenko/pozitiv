<?php
namespace RatioEdge\Modules\Shortcodes\PieCharts\PieChartDoughnut;
...
class PieChartDoughnut implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Edge Pie Chart 3 (Doughnut)', 'ratio'),
			'base' => $this->getBase(),
			'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$html = ratio_edge_get_shortcode_module_template_part('templates/pie-chart-doughnut', 'piecharts/piechartdoughnut', '', $params);
