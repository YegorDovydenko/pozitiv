<?php
namespace RatioEdge\Modules\Shortcodes\VerticalSplitSliderContentItem;
...
class VerticalSplitSliderContentItem implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Slide Content Item', 'ratio'),
			'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html = ratio_edge_get_shortcode_module_template_part('templates/vertical-split-slider-content-item-template', 'vertical-split-slider', '', $params);
