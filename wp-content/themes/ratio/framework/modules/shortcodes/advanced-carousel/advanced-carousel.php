<?php
namespace RatioEdge\Modules\Shortcodes\AdvancedCarousel;
 ...
 */
class AdvancedCarousel implements ShortcodeInterface{

	private $base;

	function __construct() {
		$this->base='edgtf_advanced_carousel';
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Edge Advanced Carousel', 'ratio'),
			'base' => $this->base,
			'icon' => 'icon-wpb-advanced-carousel extended-custom-icon',
			'category' => 'by EDGE',
			...
			'params' => array(
				...
				array(
					...
					'param_name' => 'speed',
					'description' => 'Time in milliseconds it takes to rotate the slides. Default value is 600.',
                    'admin_label' => true
				),
				array(
                    'type'        => 'dropdown',
	...
	public function render($atts, $content = null) {
		...
		$html = ratio_edge_get_shortcode_module_template_part('templates/advanced-carousel', 'advanced-carousel', '', $params);
