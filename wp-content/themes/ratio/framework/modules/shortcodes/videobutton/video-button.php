<?php
namespace RatioEdge\Modules\Shortcodes\VideoButton;
...
class VideoButton implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Edge Video Button', 'ratio'),
				'base' => $this->getBase(),
				'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$html = ratio_edge_get_shortcode_module_template_part('templates/video-button-template', 'videobutton', '', $params);
