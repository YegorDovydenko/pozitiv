<?php
namespace RatioEdge\Modules\Shortcodes\Accordion;
...
class Accordion implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Edge Accordion', 'ratio'),
			'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$output .= ratio_edge_get_shortcode_module_template_part('templates/accordion-holder-template','accordions', '', $params);
