<a href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>" <?php ratio_edge_inline_style($button_styles); ?> <?php ratio_edge_class_attribute($button_classes); ?> <?php echo ratio_edge_get_inline_attrs($button_data); ?> <?php echo ratio_edge_get_inline_attrs($button_custom_attrs); ?>>
