...
use RatioEdge\Modules\Header\Types;
/**
...
class HeaderFactory {
    ...
    public function validHeaderObject($header_object = null) {
        ...
        return is_subclass_of($header_object, 'RatioEdge\Modules\Header\Lib\HeaderType');
    }
        ...
        if($headerType !== '') {
            switch($headerType) {
				...
				case 'header-slide-down':
					$this->headerObject = new Types\HeaderSlideDown();
					break;
                default:
                    break;
            }
