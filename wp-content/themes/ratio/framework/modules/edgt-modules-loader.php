...
if(!function_exists('ratio_edge_load_widget_class')) {
	 /**
     * Loades widget class file. 
     *
     */
	function ratio_edge_load_widget_class(){
		include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/widgets/lib/widget-class.php';
	} 
	
	add_action('ratio_edge_before_options_map', 'ratio_edge_load_widget_class');
}

if(!function_exists('ratio_edge_load_widgets')) {
    /**
     * Loades all widgets by going through all folders that are placed directly in widgets folder
     * and loads load.php file in each. Hooks to ratio_edge_after_options_map action
     */
    function ratio_edge_load_widgets() {
    ...
    add_action('ratio_edge_before_options_map', 'ratio_edge_load_widgets');
}