<?php
if ( ! function_exists( 'ratio_edge_init_google_fonts_array' ) ) {
	function ratio_edge_init_google_fonts_array() {

		global $ratio_edge_fonts_array;
		$ratio_edge_fonts_array =
			array(
				0   =>
					array(
	...
	add_action('after_setup_theme', 'ratio_edge_init_google_fonts_array');
}