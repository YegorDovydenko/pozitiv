...
/*
  Class: RatioEdgeIconCollections
...
class RatioEdgeIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new RatioEdgeIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new RatioEdgeIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new RatioEdgeIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new RatioEdgeLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new RatioEdgeSimpleLineIcons('Simple Line Icons', 'simple_line_icons'));
        $this->addIconCollection('dripicons', new RatioEdgeDripicons('Dripicons', 'dripicon'));
        $this->addIconCollection('ico_moon', new RatioEdgeIcoMoonIcons('Ico Moon', 'ico_moon'));
    }
    ...
    public function getIconCollectionIcons(iRatioEdgeIconCollection $collection) {
...
if ( ! function_exists( 'ratio_edge_activate_theme_icons' ) ) {

	function ratio_edge_activate_theme_icons() {
		global $ratio_edge_IconCollections;
		$ratio_edge_IconCollections = RatioEdgeIconCollections::get_instance();
	}

	add_action('after_setup_theme', 'ratio_edge_activate_theme_icons');
}