...
<header id="header">
	<div class="container">
		...
		<div class="header_menu">
			...
			<!-- Начало выпадающей менюшки -->
			<div class="menu_1 dropdown">
  				<a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">КАТАЛОГ</a>
			  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			    <a class="dropdown-item" href="#">КУХНИ</a>
			    <a class="dropdown-item" href="#">ШКАФЫ-КУПЕ</a>
			    <a class="dropdown-item" href="#">КОРПУСНАЯ МЕБЕЛЬ</a>
			    <a class="dropdown-item" href="#">ДЕКОРАТИВНЫЕ ПАНЕЛИ</a>
			    <a class="dropdown-item" href="#">ФРЕЗЕРОВАННЫЕ ФАСАДЫ</a>
			  </div>
			</div>
			<!-- Конец выпадающей менюшки -->
			<div class="menu_1">
				<a href="#">СТАТЬИ</a>
			</div>
			<div class="menu_1">
